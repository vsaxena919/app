...
if ( ! class_exists( 'ohio_widget_socialbar' ) ) {
	...
	class ohio_widget_socialbar extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			<div class="socialbar small">
				<?php if ( $facebook ) : ?>
					<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo rawurlencode( get_permalink() ); ?>" target="_blank" class="social brand-color-hover rounded">
						<span class="icon fa fa-facebook-f"></span>
					</a>
				<?php endif; ?>

				<?php if ( $twitter ) : ?>
					<a href="https://twitter.com/intent/tweet?text=<?php echo urlencode( $post->post_title ); ?>,+<?php echo rawurlencode( get_permalink() ); ?>" target="_blank" class="social brand-color-hover rounded">
						<span class="icon fa fa-twitter"></span>
					</a>
				<?php endif; ?>

				<?php if ( $googleplus ) : ?>
					<a href="https://plus.google.com/share?url=<?php echo rawurlencode( get_permalink() ); ?>" target="_blank" class="social brand-color-hover rounded">
						<span class="icon fa fa-google"></span>
					</a>
				<?php endif; ?>

				<?php if ( $linkedin ) : ?>
					<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo rawurlencode( get_permalink() ); ?>&title=<?php echo urlencode( $post->post_title ); ?>&source=<?php echo urlencode( get_bloginfo( 'name' ) ); ?>" target="_blank" class="social brand-color-hover rounded">
						<span class="icon fa fa-linkedin"></span>
					</a>
				<?php endif; ?>

				<?php if ( $pinterest ) : ?>
					<a href="http://pinterest.com/pin/create/button/?url=<?php echo rawurlencode( get_permalink() ); ?>&description=<?php echo urlencode( $post->post_title ); ?>" target="_blank" class="social brand-color-hover rounded">
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'googleplus' ) ); ?>"><?php esc_html_e( 'Google+', 'ohio-extra' ); ?>:</label>
