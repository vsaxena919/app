<?php
	...
	if ( OhioOptions::get( 'page_footer_fixed_typography_color', 'global' ) ) {
	...
	<div class="<?php echo esc_attr( implode( ' ', $page_container_classes ) ); ?>">
		<div class="widgets vc_row">
			<?php if ( is_active_sidebar('ohio-sidebar-footer-1') ) : ?>
				<div class="vc_col-lg-<?php echo esc_attr( intval( 12 / $footer_widgets_count ) ); ?> vc_col-sm-6 widgets-column">
