...
function ohio_register_plugins() {
	$plugins = array(
		...
		array(
			'name' => 'Ohio Portfolio',
			'slug' => 'ohio-portfolio',
			'source' => 'https://plugins.clbthemes.com/ohio-portfolio-v100.zip',
			'required' => true,
			'version' => '1.0.0',
			'force_activation' => false,
			'force_deactivation' => false
		...
		array(
			'name' => 'Ohio Extra',
			'slug' => 'ohio-extra',
			'source' => 'https://plugins.clbthemes.com/ohio-extra-v106.zip',
			'required' => true,
			'version' => '1.0.6',
			'force_activation' => false,
			'force_deactivation' => false
		...
		array(
			'name' => 'Ohio Importer',
			'slug' => 'demo-import',
			'source' => 'https://plugins.clbthemes.com/ohio-demo-import-v104.zip',
			'required' => true,
			'version' => '1.0.4',
			'force_activation' => false,
			'force_deactivation' => false
