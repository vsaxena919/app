...
function ohio_woocommerce_isa_extended_paypal_icon()
{
    return get_template_directory_uri() . '/assets/images/paypal.svg';
}

add_filter('woocommerce_paypal_icon', 'ohio_woocommerce_isa_extended_paypal_icon');
...
function ohio_override_new_gravatar($avatar_defaults)
{
    $myavatar = get_template_directory_uri() . 'assets/images/sc_gap_user.svg';
    $avatar_defaults[$myavatar] = esc_html__('Ohio Default Avatar', 'ohio');
    return $avatar_defaults;
}

add_filter('avatar_defaults', 'ohio_override_new_gravatar');
