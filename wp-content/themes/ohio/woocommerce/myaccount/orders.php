...
<?php if ( $has_orders ) : ?>
	<div class="woo_c-account-orders">
		<h4 class="woo_c-account-orders-title"><?php echo esc_html('Order list') ?></h4>
		<p class="woo_c-account-orders-subtitle"><?php echo esc_html('Your recent orders are displayed in the table below.') ?></p>
