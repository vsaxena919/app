	...
	<section class="woo-cart-empty">
		<div class="page-container">
			...
			<div class="clb-blank">
				...
				<h3 class="clb-blank-headline empt-container-headline ">
				...
				<div class="clb-blank-search empt-container-cta">
					<a class="btn" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
						<?php esc_html_e( 'Go Shopping', 'ohio' ) ?> <i class="ion-right ion"><svg class="arrow-icon" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 7H16M16 7L11 1M16 7L11 13" stroke-width="2"/></svg></i>
					</a>
				</div>
			</div>
		</div>
