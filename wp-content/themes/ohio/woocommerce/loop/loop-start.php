...
<div>
	<ul class="products woo_c-products vc_row<?php echo esc_attr($grid_classes) ?>" <?php echo esc_html( $masonry_atts ); ?> data-lazy-container="posts" <?php echo esc_attr($asymmetric_atts) ?>>
